...
<duowan:override name="content">
	...
	<div class="queryPanel">
		<fieldset>
			...
			<table>
				<tr>	
					...
					<td>
						<input value="${query.durable}" id="durable" name="durable" maxlength="3"  class="validate-integer max-value-2147483647"/>
					</td>
		...
		<div class="handleControl">
			...
			<input type="button" class="stdButton" style="width:80px" value="新增" onclick="window.location = '${ctx}/queue/add.do'"/>
		<div>
		...
		<table width="100%"  border="0" cellspacing="0" class="gridBody">
		  <thead>
			  ...
			  <tr>
				...
				<th sortColumn="durable" >是否持久队列</th>
		  ...
		  <tbody>
			  ...
			  <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
				...
				<td><c:out value='${item.durable}'/>&nbsp;</td>
