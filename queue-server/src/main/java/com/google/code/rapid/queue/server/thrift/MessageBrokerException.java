...
public class MessageBrokerException extends TException implements org.apache.thrift.TBase<MessageBrokerException, MessageBrokerException._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new MessageBrokerExceptionStandardSchemeFactory());
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MessageBrokerException.class, metaDataMap);
  }
  ...
  public MessageBrokerException deepCopy() {
    return new MessageBrokerException(this);
  }
  ...
  public MessageBrokerException setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MessageBrokerException)
      return this.equals((MessageBrokerException)that);
    return false;
  }
  ...
  public int compareTo(MessageBrokerException other) {
  ...
  private static class MessageBrokerExceptionStandardSchemeFactory implements SchemeFactory {
    public MessageBrokerExceptionStandardScheme getScheme() {
      return new MessageBrokerExceptionStandardScheme();
    }
  }

  private static class MessageBrokerExceptionStandardScheme extends StandardScheme<MessageBrokerException> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MessageBrokerException struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MessageBrokerException struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MessageBrokerExceptionTupleSchemeFactory implements SchemeFactory {
    public MessageBrokerExceptionTupleScheme getScheme() {
      return new MessageBrokerExceptionTupleScheme();
    }
  }

  private static class MessageBrokerExceptionTupleScheme extends TupleScheme<MessageBrokerException> {
