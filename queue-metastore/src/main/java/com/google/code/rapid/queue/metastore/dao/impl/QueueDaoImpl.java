...
public class QueueDaoImpl extends BaseSpringJdbcDao implements QueueDao{
	...
	static final private String COLUMNS = "queue_name,vhost_name,remarks,durable,auto_delete,auto_delete_expires,exclusive,size,max_size,ttl,created_time,operator,last_updated_time";
	...
	public void insert(Queue entity) {
		String sql = "insert into rq_queue " 
			 + " (queue_name,vhost_name,remarks,durable,auto_delete,auto_delete_expires,exclusive,size,max_size,ttl,created_time,operator,last_updated_time) " 
			 + " values "
			 + " (:queueName,:vhostName,:remarks,:durable,:autoDelete,:autoDeleteExpires,:exclusive,:size,:maxSize,:ttl,:createdTime,:operator,:lastUpdatedTime)";
	...
	public int update(Queue entity) {
		String sql = "update rq_queue set "
					+ " remarks=:remarks,durable=:durable,auto_delete=:autoDelete,auto_delete_expires=:autoDeleteExpires,exclusive=:exclusive,size=:size,max_size=:maxSize,ttl=:ttl,created_time=:createdTime,operator=:operator,last_updated_time=:lastUpdatedTime "
